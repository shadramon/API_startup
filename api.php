...
function register($user, $pass) {
	...
	if (mysql_error()=="")
       //mistake here was using !$result['error'] which was producing an error to the application i replaced it in all the files with mysql_error()=="" with solved the problem      
{
...
function logout() {
	...
	// effectively destroying all the user session da]\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\]]\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
// 1) don't pass any parameters - then the function will fetch all photos from thedatabase
